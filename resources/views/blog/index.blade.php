                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="{{ url('/recipe-post') }}">Receipies</a></li>
                                    <li><a href="{{ url('/recipe-post') }}">4 Vegans</a></li>
                                    <li><a href="{{ url('/contact') }}">Contact</a></li>
                                </ul>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-catagory">
                        ...
                        <div class="top-cta-content">
                            ...
                            <a href="{{ url('/recipe-post') }}" class="btn delicious-btn">See Full Receipe</a>
                        </div>
                    </div>
                </div>
                <!-- Top Catagory Area -->
